...
TRUTH <- fread(file.path(DATA, "1.1_bin_truth.csv"))
ESTIMATED <- file.path(DATA, "1.1_neutral_out_GENIE")
...
print(comparison[, .(bin_label, V_observed, V_estimated, SE_raw,
                     ratio, z, true_share, est_share)])

fwrite(comparison, file.path(DATA, "1.1_genie_vs_truth.csv"))
